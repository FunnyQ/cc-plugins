...
│   │   │                                 # lorekeeper+judge+codifier+barrowkeeper / annalist (release)
...
└── opencode/                          # OpenCode runtime layer — repo infra, outside packages/, owns no version
    ...
    ├── install.test.ts
    ├── agents/                            # 9 chronicle agents in OpenCode frontmatter (committed)
