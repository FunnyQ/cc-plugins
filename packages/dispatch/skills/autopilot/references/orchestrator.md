...
- If tasks mutate shared files and could conflict in parallel, give `executeTask`'s dev agent `isolation: 'worktree'`. Do this only if real conflicts occur — it is expensive.
